...
// );
// lemlib::ControllerSettings angular_controller(0.295, // proportional gain (kP)
//                                               0, // integral gain (kI)
...
// // Auton
// #define BOT_CIRCUMFERENCE = 109.55; // distance between wheels
// #define DEG_TO_CM = 7.66; // degrees of drivebase motor rotation per centimeter
// #define RAMP_FULL_DEG = 1241; // full ramp turn in motor degrees
// int auton_volt = 26;
